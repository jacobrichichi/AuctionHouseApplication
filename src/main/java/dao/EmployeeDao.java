...
public class EmployeeDao {
	...
	public String addEmployee(Employee employee) {
		 ...
		 * You need to handle the database insertion of the employee details and return
		 * "success" or "failure" based on result of the database insertion.
		 */
		try {
			...
			int i = st.executeUpdate(
					"INSERT INTO Employees (SSN, LastName, FirstName, Address, City, State, ZipCode, Telephone, StartDate, HourlyRate, Email) VALUES ("
							+ employee.getEmployeeID() + "," + employee.getLastName() + "," +
							employee.getFirstName() + "," + employee.getAddress() + ", " + employee.getCity() + ","
							+ employee.getState() + "," +
							employee.getZipCode() + "," + employee.getTelephone() + ", " + employee.getStartDate() + ","
							+ employee.getHourlyRate() + "," + employee.getEmail() + ")");
	...
	public String editEmployee(Employee employee) {
		 ...
		 * e.g. firstName can be accessed by employee.getFirstName() method.
		 * The sample code returns "success" by default.
		 * You need to handle the database update and return "success" or "failure"
		 * based on result of the database update.
		 */
		try {
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection(DB_URL, DB_ROOT_USR, DB_ROOT_PW);
			...
			String s = "UPDATE Employees SET LastName = \'" + employee.getLastName() +
					"\', FirstName = \'" + employee.getFirstName() + "\', Address = \'" + employee.getAddress()
					+ "\', City = \'" + employee.getCity() +
					"\', State = \'" + employee.getState() + "\', ZipCode = \'" + employee.getZipCode()
					+ "\', Telephone = \'" + employee.getTelephone() +
					"\', StartDate = \'" + employee.getStartDate() + "\', HourlyRate = " + employee.getHourlyRate()
	...
	public String deleteEmployee(String employeeID) {
		 ...
		 * method parameter
		 * The sample code returns "success" by default.
		 * You need to handle the database deletion and return "success" or "failure"
		 * based on result of the database deletion.
		 */
	...
	public List<Employee> getEmployees() {
		 ...
		 * Each record is required to be encapsulated as a "Employee" class object and
		 * added to the "employees" List
		 */
		...
		try {
			...
			while (rs.next()) {
				...
				/*
				 * rs2 = st.executeQuery("SELECT * FROM CustomerRepresentative WHERE SSN = " +
	...
	public Employee getEmployee(String employeeID) {
		 ...
		 * be written here
		 * employeeID, which is the Employee's ID who's details have to be fetched, is
	...
	public String getEmployeeID(String username) {
		 ...
		 * written here
		 * username, which is the Employee's email address who's Employee ID has to be
